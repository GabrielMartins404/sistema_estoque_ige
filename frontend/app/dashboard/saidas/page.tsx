...
export default function MovimentacoesPage() {
    ...
    const { movimentacoes, isLoading, cadastrarMovimentacao, cancelarMovimentacao, isCreating } = useMovimentacaoManager("S", "F")
    ...
    const handleFormSubmit = (formValues: MovimentacaoFormValues) => {
        ...
        const apiRequestData: RequestMovimentacaoType = {
            ...
            movRequisitanteId: Number(formValues.movRequisitanteId), // Converte para string se necessário
